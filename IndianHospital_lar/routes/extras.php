...
Route::group(['prefix' => 'extras', 'middleware' => 'auth'], function () {
    ...
    Route::post('sendBill/{id}', [MailController::class, 'sendMail']);
    Route::post('sendOldBill/{id}', [MailController::class, 'sendMail']);

    Route::post('sendOldIPBill/{id}', [MailController::class, 'sendIPMail']);
