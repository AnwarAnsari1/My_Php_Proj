...
class PDF extends Code128
{
    ...
    public function header(): void
    {
        if ($this->headerType === 'wh') {
            ...
            // $this->image(config('paths.watermark'), 40, 100, 140, 120);
            $this->Image(config('paths.header'), 0, 0, 212, 30);
            // $this->setFont('archivo', 'B', 16);
            // $this->text(75, $this->getY() - 2, 'CREDENCE HOSPITAL');
...
$pdf->setFont('archivo', 'B', 12);
$pdf->setX(11);
$pdf->cell(25, 5, '', 0, 0, 'C');
$pdf->cell(60);
$pdf->cell(85, 5, '', 0, 1, 'R');
$pdf->setXY(20,250);
$pdf->cell(140, 20, 'No Substitute', 0, 0);

// $pdf->image(config('paths.sign'), 30, $pdf->getY() - 8, 25, 12);
// $pdf->cell(140, 20, 'Dr Veda Raghavendra vaidya', 0, 0);
// $pdf->ln(6);
// $pdf->cell(22, 20, '', 0, 0);
// $pdf->cell(160, 20, 'Pathologist', 0, 0);
// $pdf->ln(6);
// $pdf->cell(22, 20, '', 0, 0);
// $pdf->cell(160, 20, 'MBBS,DCP', 0, 0);
